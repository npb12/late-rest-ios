//
//  VersatileTextField.swift
//  Hank
//
//  Created by Neil Ballard on 11/5/18.
...
@IBDesignable
open class VersatileTextField: UITextField {
    ...
    fileprivate final func init_VersatileTextField() {
        borderStyle = .none
        createTitleLabel()
        createLineView()
        updateColors()
    ...
    fileprivate func addEditingChangedObserver() {
        self.addTarget(self, action: #selector(VersatileTextField.editingChanged), for: .editingChanged)
    }
